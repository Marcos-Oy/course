...
4. Iniciar Parallax
5. Iniciar Barras de Progreso
6. Iniciar Acordeones
7. Iniciar Cargadores
8. Iniciar Hitos
		    	...
		    	.on('start', function()
		    	{
		    		var pbar = new ProgressBar.Line(eleName, 
		    		{
						...
						text: {
							style: {
								// Color del texto.
								// Por defecto: igual al color del trazo (options.color)
		...
		if($('.loader').length)
		{
			...
			loaders.each(function()
			{
		    	...
		    	.on('start', function()
		    	{
					...
					{
						color: '#aaa',
						// Esto debe tener el mismo tamaño que el ancho máximo para
						// evitar recortes
						strokeWidth: 4,
						trailWidth: 10,
						trailColor: '#f8f4f4',
						...
						// Establece la función de paso por defecto para todas las llamadas a animate
					...
					bar.animate(endValue);  // Número de 0.0 a 1.0
		    	})
			    .addTo(ctrl);
			});
		}
	...
	function initMilestones()
	{
		if($('.milestone_counter').length)
		{
	    	...
	    	milestoneItems.each(function(i)
	    	{
	    		...
	    		/* Usa data-sign-before y data-sign-after para agregar signos
	    		delante o detrás del número del contador */
	    		var signBefore = "";
	    		var signAfter = "";
